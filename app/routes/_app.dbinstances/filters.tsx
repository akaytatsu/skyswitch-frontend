...
import { DbInstancesFilterModel } from "~/models/dbinstances.model";
...
export function Filter() {
  ...
  const form = useForm<DbInstancesFilterModel>({
    resolver: zodResolver(DbInstancesFilterModel.schema),
    defaultValues: new DbInstancesFilterModel(),
  });
  ...
  const mapQueryParamToForm = () => {
    ...
    searchParams.forEach((value, key) => {
      ...
      const formKey = toCamelCase(key) as keyof DbInstancesFilterModel;
  ...
  const onClearFilters = () => {
    form.reset(new DbInstancesFilterModel());
    navigate(``);
  };
