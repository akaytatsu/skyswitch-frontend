...
import { LogFilterModel } from "~/models/log.model";
...
export function Filter() {
  ...
  const form = useForm<LogFilterModel>({
    resolver: zodResolver(LogFilterModel.schema),
    defaultValues: new LogFilterModel(),
  });
  ...
  const mapQueryParamToForm = () => {
    ...
    searchParams.forEach((value, key) => {
      ...
      const formKey = toCamelCase(key) as keyof LogFilterModel;
