...
import { CalendarFilterModel } from "~/models/calendar.model";
...
export function Filter() {
  ...
  const form = useForm<CalendarFilterModel>({
    resolver: zodResolver(CalendarFilterModel.schema),
    defaultValues: new CalendarFilterModel(),
  });
  ...
  const mapQueryParamToForm = () => {
    ...
    searchParams.forEach((value, key) => {
      ...
      const formKey = toCamelCase(key) as keyof CalendarFilterModel;
  ...
  const onClearFilters = () => {
    form.reset(new CalendarFilterModel());
    navigate(``);
  };
