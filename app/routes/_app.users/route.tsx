...
export default function AppIndex() {
  ...
  const registerData = data as TableModel<UsersModel>;
  ...
  const [stateData, setState] = useState<UsersModel | undefined>();
          ...
          <CardHeader className="w-full flex flex-row justify-between items-center space-x-4 space-y-0">
            ...
            <div className="flex justify-end items-center space-x-6">
              <Button
                type="button"
                variant={"default"}
                onClick={() => setState(new UsersModel({}))}
              >
