...
export function Filter() {
  ...
  const form = useForm<InstancesFilterModel>({
    resolver: zodResolver(InstancesFilterModel.schema),
    defaultValues: new InstancesFilterModel(),
  });
  ...
  const mapQueryParamToForm = () => {
    ...
    searchParams.forEach((value, key) => {
      ...
      const formKey = toCamelCase(key) as keyof InstancesFilterModel;
  ...
  const onClearFilters = () => {
    form.reset(new InstancesFilterModel());
    navigate(``);
  };
